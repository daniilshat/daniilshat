...
- [Хакер взломал PS5 с помощью уязвимости, исправленной во времена PS4](https://habr.com/ru/post/689742/)
- [Исследование: каждый четвёртый пользователь Netflix в США готов отказаться от подписки](https://habr.com/ru/post/689732/)
<!-- BLOG-POST-LIST:END -->  
