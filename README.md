...
- [Netflix продолжает бороться с практикой общего использования одного аккаунта среди пользователей, не живущих вместе](https://habr.com/ru/post/656193/)
- [Google пообещала начать альфа-тестирование Steam на ChromeOS, но точных сроков не назвала](https://habr.com/ru/post/656179/)
- [Очки Ray-Ban Stories от Facebook теперь могут записывать видео длительностью до минуты](https://habr.com/ru/post/656159/)
- [Ученые представили датчики, распространяющиеся по местности, как семена одуванчиков](https://habr.com/ru/post/656077/)
- [Meta добавила новые инструменты родительского контроля для Instagram и VR](https://habr.com/ru/post/656073/)
<!-- BLOG-POST-LIST:END -->  
