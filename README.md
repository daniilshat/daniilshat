...
- [Google возвращает цифровой кошелек Google Wallet](https://habr.com/ru/post/665268/)
- [Twitter запустил веб-игру, чтобы пользователям было легче понять политику конфиденциальности сервиса](https://habr.com/ru/post/665262/)
<!-- BLOG-POST-LIST:END -->  
