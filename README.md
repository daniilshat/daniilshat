...
- [Spotify тестирует функцию, выводящую популярные пользовательские плейлисты на главную страницу приложения](https://habr.com/ru/post/659233/)
- [Релиз дистрибутива Deepin 20.5](https://habr.com/ru/post/659209/)
- [Правоохранительные органы Германии заблокировали инфраструктуру нелегального даркнет-магазина Hydra Market](https://habr.com/ru/post/659163/)
- [Ошибка Android Auto переключает настройки языка по умолчанию на региональные диалекты](https://habr.com/ru/post/659081/)
- [Epic Games анонсировала RealityScaner — приложение для создания 3D-моделей с помощью камеры смартфона](https://habr.com/ru/post/659047/)
<!-- BLOG-POST-LIST:END -->  
