...
- [СМИ: параллельный импорт может стать лазейкой для мошенников](https://habr.com/ru/post/666190/)
- [Разработчик представил утилиту, добавляющую в Linux сообщение об активации из Windows](https://habr.com/ru/post/666132/)
<!-- BLOG-POST-LIST:END -->  
