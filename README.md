...
- [AR-гарнитура Apple позволит создавать приложения дополненной реальности с помощью Siri и без кода](https://habr.com/ru/post/713688/)
- [Baidu в марте запустит аналога чат-бота ChatGPT](https://habr.com/ru/post/713658/)
