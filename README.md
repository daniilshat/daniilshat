...
- [Intel представила Wall Street Canyon NUC 12 Pro на базе Alder Lake](https://habr.com/ru/post/683390/)
- [Индия может законодательно закрепить USB-C в качестве стандартного разъёма для гаджетов](https://habr.com/ru/post/683346/)
- [VPN-сервисы на iOS передают трафик за пределы защищённого соединения](https://habr.com/ru/post/683332/)
- [В обновлении iOS 15.6.1 и macOS 12.5.1 исправили две критические уязвимости](https://habr.com/ru/post/683322/)
<!-- BLOG-POST-LIST:END -->  
