...
- [Пользователи жалуются, что браузер Safari на iOS прекращает работу после определённых запросов](https://habr.com/ru/post/699424/)
- [СМИ: Apple работает над собственной метавселенной](https://habr.com/ru/post/699360/)
