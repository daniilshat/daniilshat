...
- [Duolingo запустила приложение для изучения математики](https://habr.com/ru/post/695674/)
- [Apple добавила в пакет iWork функции для совместной работы](https://habr.com/ru/post/695644/)
- [Amazon закупает более 100 дизель-генераторов для ЦОД в Ирландии из-за возможных перебоев в подаче энергии грядущей зимой](https://habr.com/ru/post/695458/)
- [Bumble открыла исходный код системы Private Detector для обнаружения интимных фотографий](https://habr.com/ru/post/695436/)
<!-- BLOG-POST-LIST:END -->  
