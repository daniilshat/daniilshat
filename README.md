...
- [Google запустила бета-версию сервиса Google Play Games для ПК](https://habr.com/ru/post/697230/)
- [HaptX представила перчатки для виртуальной реальности, имитирующие прикосновения к предметам в VR-среде](https://habr.com/ru/post/697184/)
<!-- BLOG-POST-LIST:END -->  
