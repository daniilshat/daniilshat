...
- [SlashData выпустила ежегодный отчёт о трендах в IT](https://habr.com/ru/post/700958/)
- [Журналисты рассказали, какие технологии используют организаторы Чемпионата мира по футболу FIFA 2022](https://habr.com/ru/post/700898/)
- [Разработчики выяснили, что система аналитики устройств Apple собирает данные, идентифицирующие пользователя iCloud](https://habr.com/ru/post/700718/)
- [Генерация статических сайтов с Hugo](https://habr.com/ru/post/700640/)
- [LG представила вибрационные панели, превращающие приборную панель и подголовники автомобиля в динамики](https://habr.com/ru/post/700630/)
<!-- BLOG-POST-LIST:END -->  
