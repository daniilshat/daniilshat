...
- [Пользователи из США жалуются, что смартфоны Apple часто пропадают из коробок во время пересылки по программе трейд-ин](https://habr.com/ru/post/693754/)
- [Исследование: современные технологии не могут обеспечить высокий доход телекоммуникационным компаниям](https://habr.com/ru/post/693732/)
- [Sony представила компактную камеру для видеоблогеров за 500 долларов](https://habr.com/ru/post/693466/)
- [Twitter работает над функцией по контролю упоминаний пользователя](https://habr.com/ru/post/693392/)
- [Nvidia в новой версии видеодрайвера отключила защиту от майнинга LHR у видеокарт GeForce RTX 30](https://habr.com/ru/post/693350/)
<!-- BLOG-POST-LIST:END -->  
