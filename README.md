...
- [Dice представил рейтинг компаний США с самыми высокооплачиваемыми позициями для «мидлов»](https://habr.com/ru/post/710946/)
- [Sony разработала приложение для Android TV, блокирующее работу пиратских стриминговых сервисов](https://habr.com/ru/post/710928/)
- [Nvidia Broadcast теперь может удерживать взгляд пользователя в кадре](https://habr.com/ru/post/710886/)
- [Приложение Retro Pod, имитирующее интерфейс iPod Classic, пропало из App Store после резкого роста популярности](https://habr.com/ru/post/710702/)
- [Apple представила платформу Business Connect, позволяющую добавлять карточки компаний в приложения Apple](https://habr.com/ru/post/710162/)
<!-- BLOG-POST-LIST:END -->  
