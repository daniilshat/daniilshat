...
- [Из мобильных приложений правительства США начали удалять код российской компании, отвечающий за push-уведомления](https://habr.com/ru/post/699326/)
- [Учёные создали шлем виртуальной реальности для мышей на базе Raspberry Pi](https://habr.com/ru/post/699260/)
- [В веб-редакторе изображений Canva появилась функции генерации картинок по текстовому описанию](https://habr.com/ru/post/698826/)
- [data.ai: Talking Tom &amp;amp; Friends стала самой популярной франшизой мобильных игр десятилетия](https://habr.com/ru/post/698812/)
- [Apple снизила в США цены устройств по программе трейд-ин](https://habr.com/ru/post/698800/)
<!-- BLOG-POST-LIST:END -->  
