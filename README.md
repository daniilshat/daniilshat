...
- [Uber Eats начнёт доставлять заказы в Калифорнии и Техасе с помощью роботов Nuro](https://habr.com/ru/post/687462/)
- [Стали известны даты релиза iOS 16 и watchOS 9](https://habr.com/ru/post/687430/)
- [Евросоюз намерен установить строгие правила относительно IoT-устройств](https://habr.com/ru/post/687406/)
