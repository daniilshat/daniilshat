...
- [Разработчик представил утилиту, которая издаёт звук каждый раз, когда браузер отправляет данные в Google](https://habr.com/ru/post/683974/)
- [Разработчик представил дверной звонок на Raspberry Pi, реагирующий на мяуканье кота](https://habr.com/ru/post/683944/)
- [«Авто.ру» запустил «сервис знакомств» для автомобилей с пробегом](https://habr.com/ru/post/683904/)
- [Apricorn выпустила 2-терабайтную флешку с аппаратным шифрованием](https://habr.com/ru/post/683578/)
- [Ring исправила уязвимость в системе безопасности, из-за которой записи с видеодомофонов могли оказаться в руках хакеров](https://habr.com/ru/post/683422/)
<!-- BLOG-POST-LIST:END -->  
