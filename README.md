...
- [Meta* обновила список предпочтительных языков программирования для внутренней разработки — Hack, C++, Rust и Python](https://habr.com/ru/post/679936/)
- [Пользователи оформили 860 млн подписок на сервисы Apple](https://habr.com/ru/post/679912/)
- [Godot готовится заморозить разработку движка перед релизом бета-версии Godot 4.0](https://habr.com/ru/post/679872/)
- [Баннеры игр в Steam нельзя будет снабжать логотипами наград и оценками](https://habr.com/ru/post/679850/)
- [НАСА тестирует прототип электрического фургона для доставки астронавтов к месту старта ракеты](https://habr.com/ru/post/679716/)
<!-- BLOG-POST-LIST:END -->  
