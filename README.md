...
- [Microsoft проведёт конференцию для разработчиков Ignite в октябре](https://habr.com/ru/post/679672/)
- [Orbit Fab пожертвует реголит в фонд лунных ресурсов](https://habr.com/ru/post/679356/)
<!-- BLOG-POST-LIST:END -->  
