...
- [Инсайдеры: Apple полностью откажется от Lightning только в iPhone 16](https://habr.com/ru/post/670796/)
- [В автомобилях Tesla обнаружили  ошибку, позволяющую добавлять в память авто новые NFC-ключи](https://habr.com/ru/post/670758/)
- [Американский стартап Brown Foods создал искусственное молоко из культивируемых клеток](https://habr.com/ru/post/670712/)
- [Google рассчитала число Пи до 100 триллионов знаков после запятой](https://habr.com/ru/post/670706/)
- [В GitHub расширили количество достижений для разработчиков проектов с открытым исходным кодом](https://habr.com/ru/post/670678/)
<!-- BLOG-POST-LIST:END -->  
