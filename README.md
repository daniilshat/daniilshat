...
- [Пользователи macOS 12.3 жалуются на проблемы с игровыми контроллерами и внешними мониторами](https://habr.com/ru/post/657339/)
- [Google прекратит лицензирование Android-смартфонов под российскими брендами](https://habr.com/ru/post/657267/)
- [Unity представила демо-игру Gigaya, которая научит начинающих разработчиков создавать игры](https://habr.com/ru/post/657251/)
- [Состоялся релиз GNOME 42](https://habr.com/ru/post/657231/)
- [Apple запустила программу цифровых документов в Wallet](https://habr.com/ru/post/657149/)
<!-- BLOG-POST-LIST:END -->  
